...
- **`INGEST_URL`** — Obligatoria en Docker para leer Ajustes (`http://ingest:3002`).
- **`LLM_MODEL`**, **`LLM_TEMPERATURE`** — Defaults de modelo si Ajustes vacío (ver [src/llm/README.md](src/llm/README.md)). **API key solo en Ajustes UI.**
