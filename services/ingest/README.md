...
- `GET /repositories/:id/graph-summary` — Conteos y listados por label (sin `LIMIT` por defecto). Query `full=0` o `full=false` para muestra acotada (estratificada monorepo); `repoScoped=1` para acotar al repo.
