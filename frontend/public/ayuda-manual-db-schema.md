...
- **Tabla `domains`** (PostgreSQL): **dominio de arquitectura / gobierno** (nombre, color, metadata). No es el mismo concepto que `:DomainConcept`.
...
#### 5.3 `domains` (gobierno de arquitectura)
...
| `description` | text nullable | |
| `color` | varchar(16) NOT NULL default `#6366f1` | Hex UI / badges |
