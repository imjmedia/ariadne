...
- **ProjectChat.tsx** — Chat a nivel proyecto (multi-repo). Mismo layout que RepoChat: conversación a pantalla completa, análisis en panel lateral, opciones multi-repo en popover. Ruta: `/projects/:id/chat`.
...
- **RepoChat.tsx** — Chat por repositorio. Layout **una columna** (conversación primero); análisis en panel lateral bajo demanda; opciones (modo, alcance) en popover. Ruta: `/repos/:id/chat`.
